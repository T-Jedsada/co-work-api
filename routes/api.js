...
router.post('/register', midleware.any(),register_controller.store);
...
router.post('/register/forgot-password', midleware.any(), forgot_password_controller.forgot_password);
